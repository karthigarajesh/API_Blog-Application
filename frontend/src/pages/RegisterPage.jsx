...
import { UserPlus, Eye, EyeOff, ArrowRight, Feather } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-20 px-4 relative">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/3 left-1/4 w-80 h-80 bg-accent/15 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/3 right-1/4 w-60 h-60 bg-cyan/10 rounded-full blur-[100px]" />
      </div>
        ...
        <div className="glass-card p-8">
          <div className="text-center mb-8">
            <div className="w-12 h-12 rounded-xl bg-accent/10 border border-accent/20 flex items-center justify-center mx-auto mb-4">
              <UserPlus className="w-6 h-6 text-accent-light" />
            </div>
            <h1 className="text-2xl font-bold text-white mb-1">Create an account</h1>
            <p className="text-sm text-zinc-400">Join our community of writers and readers</p>
          </div>
